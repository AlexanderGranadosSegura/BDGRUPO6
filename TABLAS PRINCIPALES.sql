...
CREATE TABLE FIDE_FACTURACION_TB (
    ...
    CONSTRAINT FIDE_FACTURACION_ID_FACTURACION_PK PRIMARY KEY (id_facturacion),
    CONSTRAINT FIDE_FACTURACION_ID_PEDIDO_FK FOREIGN KEY (id_pedido) REFERENCES FIDE_PEDIDO_TB(id_pedido)
);
